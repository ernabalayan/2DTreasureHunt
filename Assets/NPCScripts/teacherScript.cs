...
public class teacherScript : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.tag == "Player")
        {
            ...
            {
                Debug.Log("teacher speaking");
                _text.text = "I dont know anything go talk to someone else";
            }
            ...
            {
                Debug.Log("teacher speaking");
                _text.text = "the gas station guy always looks like he's hiding something ";
            ...
            {
                Debug.Log("teacher speaking");
                _text.text = "here you go, the last piece you need";
            }
