...
public class boutiqueScript : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.tag == "Player")
        {
            ...
            {
                Debug.Log("boutique girl speaking");
                _text.text = "i think I have something of yours...";
            }
            ...
            {
                Debug.Log("boutique girl speaking");
                _text.text = "I think the librarian might know something";
            ...
            {
                Debug.Log(" boutique girl speaking");
                _text.text = " the chef might know more than me";
            }
